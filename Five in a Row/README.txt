...
The game is divided into Server and Client (don't be fooled by the name Server: at the moment, there's no networking
 code). The Server handles the game logic. The Client controls players and displays the game to them.
